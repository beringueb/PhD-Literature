...
NlTT = np.loadtxt("temp_fishpy/NlTT.temp")
NlEE = np.loadtxt("temp_fishpy/NlEE.temp")
...
# filter functions
lt        = np.zeros( lmax+1 ); flt[2:] = 1./cltt[2:]
