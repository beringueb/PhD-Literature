...
def init_file(setup):
    ...
    pars_fid.set_cosmology(H0=H0_tmp,cosmomc_theta=cosmomc_theta_tmp,ombh2=setup.fiducial['ombh2'],omch2=setup.fiducial['omch2'],mnu = setup.mass_neutrinos/1000.,nnu=setup.fiducial['N_eff'],tau=setup.fiducial['tau'],YHe=YHe_tmp)
