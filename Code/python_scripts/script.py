...
param_list = ['massless_neutrinos','hubble','ombh2','omch2', 'scalar_amp','scalar_spectral_index','re_optical_depth']
...
def combine_experiment(experiment_list, param_list,rayleigh,pola) :
    ...
    if pola :
        ...
        str2 = 'nop'
    title = '../fisher_matrices/fisher_{}_{}_'.format(str1,str2) + '_'.join(experiment_list) + '_full_params.txt'
    fish = np.zeros((8,8))
...
print('\n CCAT + planck \n')
display_errors(cov_nor_ccat_planck,cov_r_ccat_planck)
print('\n SO + planck \n')
display_errors(cov_nor_SO_planck,cov_r_SO_planck)
print('\n CMB-S4 + planck \n')
display_errors(cov_nor_S4_planck,cov_r_S4_planck)
print('\n CCAT + SO + planck \n')
