...
def combine_experiment(experiment_list, param_list,rayleigh,pola) :
    ...
    if pola :
        ...
        str2 = 'nop'
    title = root_data + 'fisher_{}_{}_'.format(str1,str2) + '_'.join(experiment_list) + '_full_params.txt'
    fish = np.zeros((8,8))
...
print('50-250 \n')
display_errors(cov_nor_grid, cov_r_grid_250, param_list )
print('\n 250-500 \n')
display_errors(cov_nor_grid, cov_r_grid_250_500, param_list )
print('\n 500-750 \n')
display_errors(cov_nor_grid, cov_r_grid_500_750, param_list )
print('\n 750-900 \n')
display_errors(cov_nor_grid, cov_r_grid_750_900, param_list )
print('\n full \n')
display_errors(cov_nor_grid, cov_r_grid_full, param_list )
