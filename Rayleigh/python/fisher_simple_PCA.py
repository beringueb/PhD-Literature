...
def run_camb(position, sign) :
    subprocess.call("./camb {}".format(param_file_root + "PCA_init/params_PCA_{:07.2f}_{:d}.ini".format(position,sign)), shell = True, cwd = "/home/bb510/Code/CAMB/", stderr = subprocess.DEVNULL, stdout = subprocess.DEVNULL)
